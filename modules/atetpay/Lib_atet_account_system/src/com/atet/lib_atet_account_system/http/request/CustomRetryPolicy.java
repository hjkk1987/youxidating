...
public class CustomRetryPolicy implements RetryPolicy{
    ...
    public static final int DEFAULT_TIMEOUT_MS = 40*1000;
    ...
    public void retry(VolleyError error) throws VolleyError {
    	...
    	System.out.println("volley retry retrycount :"+mCurrentRetryCount);
        mCurrentRetryCount++;
        System.out.println("volley retry after retrycount :"+mCurrentRetryCount);
