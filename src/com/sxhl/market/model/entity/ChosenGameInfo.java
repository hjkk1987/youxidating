...
public class ChosenGameInfo extends BaseModel implements AutoType,Serializable{
	...
	public String toString() {
		return "ChosenGameInfo [gameId=" + gameId + ", gameName=" + gameName
				+ ", maxPhoto=" + maxPhoto + ", middlePhoto=" + middlePhoto
				+ ", minPhoto=" + minPhoto + ", gameLevel=" + gameLevel
				+ ", gameDownCount=" + gameDownCount + ", gameSize=" + gameSize
				+ ", gamePrice=" + gamePrice + ", briedDesc=" + briedDesc
				+ ", gameUpdateTime=" + gameUpdateTime + ", packageName="
				+ packageName + ", downAddress=" + downAddress + ", typeId="
