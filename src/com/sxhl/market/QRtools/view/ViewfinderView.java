...
package com.sxhl.market.QRtools.view;
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		maskColor = resources.getColor(Res.color(context, "viewfinder_mask"));
		resultColor = resources.getColor(Res.color(context, "result_view"));
		frameColor = resources.getColor(Res.color(context, "viewfinder_frame"));
		laserColor = resources.getColor(Res.color(context, "viewfinder_laser"));
		resultPointColor = resources.getColor(Res.color(context,
	...
	public void onDraw(Canvas canvas) {
		...
		if (frame == null) {
			Toast.makeText(context, context.getString(R.string.hintNocamera), 2 * 1000).show();
			return;
		}
		...
		if (resultBitmap != null) {
			...
			// 画扫描框边上的角，总共8个部分
			paint.setColor(getResources().getColor(R.color.scanning));
			...
			String str = "请将二维码放入框内";
			float fontWidt = paint.measureText(str);

			canvas.drawText(
					str,
					(screenWidth - fontWidt) * 0.5f,
