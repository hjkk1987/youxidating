...
package com.sxhl.market.QRtools.camera;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int width  = (int) (screenResolution.x * 0.75f);
	...
	public Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			// screenResolution.y;
			/*
			 * Log.i("xj", "rect===="+rect.left+"|"+rect.right
			 * +"|"+rect.top+"|"+rect.bottom); Log.i("xj",
			 * "cameraResolution===="+cameraResolution.x+"|"+cameraResolution.y
			 * ); Log.i("xj",
	...
	public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
		...
		// Log.i("xj", "previewFormat:"+previewFormat + "rect:"+rect.left +
		// "rect.top:"+rect.top+"|"+rect.width()+"|"+rect.height());
